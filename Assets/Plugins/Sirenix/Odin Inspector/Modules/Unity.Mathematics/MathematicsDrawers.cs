...
namespace Sirenix.OdinInspector.Modules.UnityMathematics.Editor
{
    ...
    public class Bool2Drawer : OdinValueDrawer<bool2>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            {
                var showLabels = !this.isMatrixChild &&
                ...
                this.ValueEntry.Property.Children[0]
                        .Draw(showLabels ? GUIHelper.TempContent("X") : null);
                EditorGUILayout.EndVertical();
                EditorGUILayout.BeginVertical(options);
                this.ValueEntry.Property.Children[1]
    ...
    public class Bool3Drawer : OdinValueDrawer<bool3>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                ...
                EditorGUILayout.EndVertical();
                EditorGUILayout.BeginVertical(options);
                this.ValueEntry.Property.Children[2]
    ...
    public class Bool4Drawer : OdinValueDrawer<bool4>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                ...
                EditorGUILayout.EndVertical();
                EditorGUILayout.BeginVertical(options);
                this.ValueEntry.Property.Children[3]
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                // Slide rect
                {
                    ...
                    var vec = SirenixEditorFields.VectorPrefixSlideRect(
                            labelRect, new Vector2(val.x, val.y));
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                // Slide rect
                {
                    ...
                    EditorGUI.BeginChangeCheck();
                    var vec = SirenixEditorFields.VectorPrefixSlideRect(
                            labelRect, new Vector3(val.x, val.y, val.z));
